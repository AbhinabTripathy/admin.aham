      ...
      <StyledPaper>
        <HeaderSection>
          ...
          <Typography variant="body1" color="text.secondary">
            Create official blog content for the platform. Share insights, announcements, and valuable information with users.
          </Typography>
        </HeaderSection>
        ...
        <Box sx={{ mb: 3 }}>
          <FormControl fullWidth variant="outlined">
            <InputLabel id="category-label">Featured Product</InputLabel>
            <Select

...
import { FaRegNewspaper, FaFileAlt, FaTimesCircle, FaBook, FaHeadphones } from 'react-icons/fa';
...
const Overview = () => {
  ...
  // Static data for the creator dashboard
      ...
      <div style={gridStyle}>
        ...
        <div style={cardStyle}>
          ...
          <div style={cardContentStyle}>
            ...
            <div style={labelStyle}>Content</div>
            <div style={sublabelStyle}>Pending Review</div>
          </div>
        </div>
        ...
        <div style={cardStyle}>
          ...
          <div style={cardContentStyle}>
            ...
            <div style={labelStyle}>Content</div>
            <div style={sublabelStyle}>Needs Revision</div>
          </div>
        </div>
        ...
        <div style={cardStyle}>
          ...
          <div style={cardContentStyle}>
            <h2 style={numberStyle}>{stats.graphicNovels}</h2>
            <div style={labelStyle}>Published</div>
            <div style={sublabelStyle}>Graphic Novels</div>
          </div>
        </div>
